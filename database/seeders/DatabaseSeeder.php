...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $customers = [];
        for ($i = 1; $i <= 50; $i++) {
            // Generate random name parts first to use them for the social handle too
            ...
            $customers[] = Customer::create([
                ...
                'last_name' => $lastName,
                'address' => fake()->address(), // Also makes addresses look real
                'contact_number' => '0917'.rand(1000000, 9999999),
                // Generates a handle like @john_doe
                'social_handle' => '@'.strtolower($firstName.'_'.$lastName),
            ]);
        }
